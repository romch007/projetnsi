...
from algo import create_dict, create_weighted_dict, breadth_first_search, depth_first_search

class TestAlgo(unittest.TestCase):
    def test_create_dict(self):
        nodes = [[1, "A"], [2, "B"], [3, "C"], [4, "D"]]
        relations = [[1, 2, True, 1], [2, 4, False, 1], [2, 3, True, 1], [3, 4, False, 1]]
