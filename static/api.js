 ...
 * @returns {Array<{color: string, id: number, name: string, x: number, y: number}>} La liste des noeuds
 */
 ...
 * @returns {Array<{start_id: number, end_id: number, oriented: boolean, weight: 1}>} La liste des relations
 */
 ...
 * @returns {string} L'id du nouveau noeud
 */
 ...
 * @returns {string} "ok" dans tous les cas
 */
 ...
 * @param {number} startId L'id du noeud de départ
 * @returns {Array<number>} La liste des noeuds du parcours dans l'ordre
 */
 ...
 * @param {number} startId L'id du noeud de départ
 * @param {number} endId L'id du noeud d'arrivée
 * @returns {Array<number>} Le chemin du graphe correspond au chemin le plus court
 */
 ...
 * @returns {Object} La réponse de la requête
 */
